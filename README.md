...
![Median-filtered dx and dy offsets and their variances.](figs/aoi3_dxdy_median_var_4plots.png)

![Velocity direction and magnitude (filtered with direction) and their variances (not filtered).](figs/aoi3_median_direction_magnitude_4plots.png)
![Minimum and Maximum of averaged confidence values. The pair show the overall lowest and highest confidence values.](figs/aoi3_combined_scores_6plots.png)

![Sum of all good values. The fraction indicates that in places 50% of data are retained after filtering. In some areas, less than 30% remains.](figs/aoi3_mask_sum.png)

![Filtering based on a rigurous mask generated by method 2. Only small areas remain after filtering with angle differences. ](figs/aoi3_directions_sd.png)
